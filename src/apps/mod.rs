...
pub trait App {
    ...
    fn install(&self, prefix: &Path) -> Result<Vec<PathBuf>> {
        if !self.needs_install(prefix)? {
            log::info!(
                "lvl=INFO app={} msg=Already at latest version",
                self.exe_name()
            );
            return Ok(vec![]);
        }
...
pub fn all_app_entries() -> Vec<AppEntry> {
    vec![
        AppEntry { id: "aqua",        url: "https://github.com/aquaproj/aqua" },
        AppEntry { id: "ast-grep",    url: "https://github.com/ast-grep/ast-grep" },
        AppEntry { id: "atuin",       url: "https://github.com/atuinsh/atuin" },
        AppEntry { id: "bat",         url: "https://github.com/sharkdp/bat" },
        AppEntry { id: "caddy",       url: "https://github.com/caddyserver/caddy" },
        AppEntry { id: "carapace",    url: "https://github.com/carapace-sh/carapace-bin" },
        AppEntry { id: "chezmoi",     url: "https://github.com/twpayne/chezmoi" },
        AppEntry { id: "d4s",         url: "https://github.com/jr-k/d4s" },
        AppEntry { id: "dasel",       url: "https://github.com/TomWright/dasel" },
        AppEntry { id: "delta",       url: "https://github.com/dandavison/delta" },
        AppEntry { id: "difft",       url: "https://github.com/Wilfred/difftastic" },
        AppEntry { id: "dockmate",    url: "https://github.com/shubh-io/DockMate" },
        AppEntry { id: "dry",         url: "https://github.com/moncho/dry" },
        AppEntry { id: "eza",         url: "https://github.com/eza-community/eza" },
        AppEntry { id: "fd",          url: "https://github.com/sharkdp/fd" },
        AppEntry { id: "fnm",         url: "https://github.com/Schniz/fnm" },
        AppEntry { id: "fx",          url: "https://github.com/antonmedv/fx" },
        AppEntry { id: "fzf",         url: "https://github.com/junegunn/fzf" },
        AppEntry { id: "gitleaks",    url: "https://github.com/gitleaks/gitleaks" },
        AppEntry { id: "go",          url: "https://go.dev/" },
        AppEntry { id: "gojq",        url: "https://github.com/itchyny/gojq" },
        AppEntry { id: "gonzo",       url: "https://github.com/control-theory/gonzo" },
        AppEntry { id: "jid",         url: "https://github.com/simeji/jid" },
        AppEntry { id: "jq",          url: "https://github.com/jqlang/jq" },
        AppEntry { id: "jqp",         url: "https://github.com/noahgorstein/jqp" },
        AppEntry { id: "lazyjournal", url: "https://github.com/Lifailon/lazyjournal" },
        ...
        AppEntry { id: "restish",     url: "https://github.com/rest-sh/restish" },
        AppEntry { id: "rg",          url: "https://github.com/BurntSushi/ripgrep" },
        AppEntry { id: "rust-analyzer", url: "https://github.com/rust-lang/rust-analyzer" },
        AppEntry { id: "sd",          url: "https://github.com/chmln/sd" },
        AppEntry { id: "sk",          url: "https://github.com/skim-rs/skim" },
        AppEntry { id: "starship",    url: "https://github.com/starship/starship" },
        AppEntry { id: "stylua",      url: "https://github.com/JohnnyMorganz/stylua" },
        AppEntry { id: "uv",          url: "https://github.com/astral-sh/uv" },
        AppEntry { id: "xq",          url: "https://github.com/sibprogrammer/xq" },
        AppEntry { id: "yq",          url: "https://github.com/mikefarah/yq" },
        AppEntry { id: "zoxide",      url: "https://github.com/ajeetdsouza/zoxide" },
    ]
}
